    ...
    public partial class TrailerWindow : MetroWindow
    {
        ...
        private async Task LoadDataCollection()
        {
            ...
            var service = new YouTubeService(
                ...
                {
                    ApiKey = "AIzaSyCLfMsbkV2GImo0Aeuot85dz-1ZDL0S0dM",
        ...
        private void MetroWindow_Closing(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            BrsYoutube.Dispose(); //종종 앱 종료시 객체를 완전 해제하는 
        }
        ...
        private void LsvResult_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                var video = LsvResult.SelectedItem as YoutubeItem; // as => costing 실패하면 null
